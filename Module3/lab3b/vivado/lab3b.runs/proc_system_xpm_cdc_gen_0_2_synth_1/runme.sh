...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module3/lab3b/vivado/lab3b.runs/proc_system_xpm_cdc_gen_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_system_xpm_cdc_gen_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_system_xpm_cdc_gen_0_2.tcl
