...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module3/lab3b/vivado/lab3b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevel_lab3.tcl -notrace
