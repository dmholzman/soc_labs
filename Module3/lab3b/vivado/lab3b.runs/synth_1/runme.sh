...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module3/lab3b/vivado/lab3b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_lab3.tcl
