...
/* Definitions for peripheral AXI_RESETN */
#define XPAR_AXI_RESETN_BASEADDR 0x41200000
#define XPAR_AXI_RESETN_HIGHADDR 0x4120FFFF
#define XPAR_AXI_RESETN_DEVICE_ID 0
#define XPAR_AXI_RESETN_INTERRUPT_PRESENT 0
#define XPAR_AXI_RESETN_IS_DUAL 1


/* Definitions for peripheral AXI_PHASE_SIG */
#define XPAR_AXI_PHASE_SIG_BASEADDR 0x41210000
#define XPAR_AXI_PHASE_SIG_HIGHADDR 0x4121FFFF
#define XPAR_AXI_PHASE_SIG_DEVICE_ID 1
#define XPAR_AXI_PHASE_SIG_INTERRUPT_PRESENT 0
#define XPAR_AXI_PHASE_SIG_IS_DUAL 1


/* Definitions for peripheral AXI_PHASE_TUNE */
#define XPAR_AXI_PHASE_TUNE_BASEADDR 0x41220000
#define XPAR_AXI_PHASE_TUNE_HIGHADDR 0x4122FFFF
#define XPAR_AXI_PHASE_TUNE_DEVICE_ID 2
#define XPAR_AXI_PHASE_TUNE_INTERRUPT_PRESENT 0
#define XPAR_AXI_PHASE_TUNE_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral AXI_RESETN */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_RESETN_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral AXI_PHASE_SIG */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_PHASE_SIG_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 1

/* Canonical definitions for peripheral AXI_PHASE_TUNE */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_PHASE_TUNE_DEVICE_ID
