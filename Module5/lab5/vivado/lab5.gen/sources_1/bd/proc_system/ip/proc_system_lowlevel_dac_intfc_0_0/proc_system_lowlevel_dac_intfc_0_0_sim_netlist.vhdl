...
-- Command     : write_vhdl -force -mode funcsim -rename_top proc_system_lowlevel_dac_intfc_0_0 -prefix
--               proc_system_lowlevel_dac_intfc_0_0_ proc_system_lowlevel_dac_intfc_0_0_sim_netlist.vhdl
...
entity proc_system_lowlevel_dac_intfc_0_0_clkdivider is
  port (
...
end proc_system_lowlevel_dac_intfc_0_0_clkdivider;

architecture STRUCTURE of proc_system_lowlevel_dac_intfc_0_0_clkdivider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \proc_system_lowlevel_dac_intfc_0_0_clkdivider__parameterized0\ is
  port (
  ...
  attribute ORIG_REF_NAME of \proc_system_lowlevel_dac_intfc_0_0_clkdivider__parameterized0\ : entity is "clkdivider";
end \proc_system_lowlevel_dac_intfc_0_0_clkdivider__parameterized0\;

architecture STRUCTURE of \proc_system_lowlevel_dac_intfc_0_0_clkdivider__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity proc_system_lowlevel_dac_intfc_0_0_lowlevel_dac_intfc is
  port (
    sdata : out STD_LOGIC;
...
end proc_system_lowlevel_dac_intfc_0_0_lowlevel_dac_intfc;

architecture STRUCTURE of proc_system_lowlevel_dac_intfc_0_0_lowlevel_dac_intfc is
...
bclk_tim: entity work.\proc_system_lowlevel_dac_intfc_0_0_clkdivider__parameterized0\
     port map (
      E(0) => sel,
      Q(0) => bitcount_reg(0),
...
make12p5MHz: entity work.proc_system_lowlevel_dac_intfc_0_0_clkdivider
     port map (
      clk125 => clk125,
...
entity proc_system_lowlevel_dac_intfc_0_0 is
  ...
  attribute NotValidForBitStream of proc_system_lowlevel_dac_intfc_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of proc_system_lowlevel_dac_intfc_0_0 : entity is "proc_system_lowlevel_dac_intfc_0_0,lowlevel_dac_intfc,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of proc_system_lowlevel_dac_intfc_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of proc_system_lowlevel_dac_intfc_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of proc_system_lowlevel_dac_intfc_0_0 : entity is "lowlevel_dac_intfc,Vivado 2022.1";
end proc_system_lowlevel_dac_intfc_0_0;

architecture STRUCTURE of proc_system_lowlevel_dac_intfc_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk125 : signal is "xilinx.com:signal:clock:1.0 clk125 CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk125 : signal is "XIL_INTERFACENAME clk125, ASSOCIATED_RESET rst, ASSOCIATED_BUSIF data_in, FREQ_TOLERANCE_HZ -1, FREQ_HZ 125000000, PHASE 0.0, CLK_DOMAIN proc_system_clk_125, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of data_word : signal is "XIL_INTERFACENAME data_in, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 125000000, PHASE 0.0, CLK_DOMAIN proc_system_clk_125, LAYERED_METADATA undef, INSERT_VIP 0";
begin
U0: entity work.proc_system_lowlevel_dac_intfc_0_0_lowlevel_dac_intfc
     port map (
      bclk_i_reg_0 => bclk,
      clk125 => clk125,
