...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module5/lab5/vivado/lab5.runs/proc_system_cmpy_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_system_cmpy_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_system_cmpy_0_0.tcl
