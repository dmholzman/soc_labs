...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module5/lab5/vivado/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_lab5.tcl
