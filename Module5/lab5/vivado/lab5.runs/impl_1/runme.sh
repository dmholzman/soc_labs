...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module5/lab5/vivado/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevel_lab5.tcl -notrace
