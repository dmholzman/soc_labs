...
/* Definitions for peripheral RESET_AND_LEDS */
#define XPAR_RESET_AND_LEDS_BASEADDR 0x41200000
#define XPAR_RESET_AND_LEDS_HIGHADDR 0x4120FFFF
#define XPAR_RESET_AND_LEDS_DEVICE_ID 0
#define XPAR_RESET_AND_LEDS_INTERRUPT_PRESENT 0
#define XPAR_RESET_AND_LEDS_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral RESET_AND_LEDS */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_RESET_AND_LEDS_DEVICE_ID
