...
#
# Generated by export_simulation on Tue Feb 14 00:59:48 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './proc_system.sh' script.

./proc_system.sh -reset_run
...
./proc_system.sh -noclean_files

For more information on the script, please type './proc_system.sh -help'.
