...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_dac_test xil_defaultlib.ila_dac_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_dac_test -key {Behavioral:sim_1:Functional:ila_dac_test} -tclbatch cmd.tcl -protoinst "protoinst_files/proc_system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_dac_test.wdb xsim.dir)
