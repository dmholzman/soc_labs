...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module2/lab2/vivado/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_lab2.tcl
