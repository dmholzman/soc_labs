...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module2/lab2/vivado/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevel_lab2.tcl -notrace
