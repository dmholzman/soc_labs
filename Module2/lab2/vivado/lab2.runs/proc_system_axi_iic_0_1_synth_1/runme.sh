...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module2/lab2/vivado/lab2.runs/proc_system_axi_iic_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_system_axi_iic_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_system_axi_iic_0_1.tcl
