...
// Command     : write_verilog -force -mode synth_stub -rename_top ila_dac_test -prefix
//               ila_dac_test_ ila_dac_test_stub.v
// Design      : ila_dac_test
...
module ila_dac_test(clk, probe0, probe1, probe2, probe3, probe4, probe5, 
  probe6, probe7)
