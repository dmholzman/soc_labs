...
*
* Dirk Holzman
* Lab 4 SDR Signal Source with FIR Filter
* 3/15/2023
*
******************************************************************************/

/*
 * lab4_player.c: top level software for audio player based on SDR signal source with FIR filter.
...
// Function to calculate and write the new phase increment based off of the requested frequency.
void calcPhase (int32_t freq)
{
