...
/* Definitions for peripheral AXI_PHASE */
#define XPAR_AXI_PHASE_BASEADDR 0x41210000
#define XPAR_AXI_PHASE_HIGHADDR 0x4121FFFF
#define XPAR_AXI_PHASE_DEVICE_ID 0
#define XPAR_AXI_PHASE_INTERRUPT_PRESENT 0
#define XPAR_AXI_PHASE_IS_DUAL 1
...
#define XPAR_AXI_RESETN_DEVICE_ID 1
...
/* Canonical definitions for peripheral AXI_PHASE */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_PHASE_DEVICE_ID
...
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_RESETN_DEVICE_ID
