...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module4/Lab4/vivado/lab4.runs/proc_system_fir_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_system_fir_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_system_fir_compiler_0_0.tcl
