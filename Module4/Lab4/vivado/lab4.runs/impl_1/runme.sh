...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module4/Lab4/vivado/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevel_lab4.tcl -notrace
