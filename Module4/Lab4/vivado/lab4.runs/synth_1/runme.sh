...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module4/Lab4/vivado/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_lab4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_lab4.tcl
