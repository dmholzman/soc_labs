...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module6/lab6/radio_periph_lab_main/vivado/radio_periph_lab.runs/design_1_full_radio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_full_radio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_full_radio_0_0.tcl
