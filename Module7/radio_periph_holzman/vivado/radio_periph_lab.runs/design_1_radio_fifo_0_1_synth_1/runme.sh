...
HD_PWD='D:/Dirk/Grad_School/525.742.8VL_SOC/HW/Module7/radio_periph_holzman/vivado/radio_periph_lab.runs/design_1_radio_fifo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_radio_fifo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_radio_fifo_0_1.tcl
