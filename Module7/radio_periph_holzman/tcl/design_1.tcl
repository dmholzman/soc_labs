...
jhu.edu:user:full_radio:2.0\
jhuapl.edu:user:lowlevel_dac_intfc:1.1\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:user:radio_fifo:1.1\
...
proc create_root_design { parentCell } {
  ...
  set full_radio_0 [ create_bd_cell -type ip -vlnv jhu.edu:user:full_radio:2.0 full_radio_0 ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: radio_fifo_0, and set properties
  set radio_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:radio_fifo:1.1 radio_fifo_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins radio_fifo_0/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_iic_0_gpo [get_bd_pins axi_iic_0/gpo] [get_bd_pins lowlevel_dac_intfc_0/resetn]
  connect_bd_net -net full_radio_0_m_axis_tdata [get_bd_pins full_radio_0/m_axis_tdata] [get_bd_pins lowlevel_dac_intfc_0/data_word] [get_bd_pins radio_fifo_0/s_axis_tdata] [get_bd_pins system_ila_0/SLOT_0_AXIS_tdata]
  connect_bd_net -net full_radio_0_m_axis_tvalid [get_bd_pins full_radio_0/m_axis_tvalid] [get_bd_pins lowlevel_dac_intfc_0/valid] [get_bd_pins radio_fifo_0/s_axis_tvalid] [get_bd_pins system_ila_0/SLOT_0_AXIS_tvalid]
  ...
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins full_radio_0/s00_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins radio_fifo_0/s00_axi_aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins full_radio_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins radio_fifo_0/s00_axi_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins xpm_cdc_gen_0/dest_rst_out]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs radio_fifo_0/S00_AXI/S00_AXI_reg] -force
