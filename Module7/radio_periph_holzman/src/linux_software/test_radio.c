...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float bytes_transferred = 2048*4; // reads 32-bit word 2048 times
    float time_spent = ((float)(stop_time-start_time)) / CLOCK_RATE_MHZ;
	float throughput = (bytes_transferred * 1e-6) / time_spent; // MB/s
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Dirk Holzman - Custom Peripheral Demonstration\n\r");
